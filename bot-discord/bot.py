...
Node_story_3_1 = story(
    "vous voulez mourir ou vivre?(mourir/vivre)", "Élementaire", 0)

Node_story_3_2 = story(
    "vous voulez mourir ou vivre?(mourir/vivre)", "Mage", 0)

Node_story_3_3 = story(
    "vous voulez mourir ou vivre?(mourir/vivre)", "Guerrier", 0)

Node_story_3_4 = story(
    "vous voulez mourir ou vivre?(mourir/vivre)", "Paladin", 0)

Node_story_3_5 = story(
    "vous voulez mourir ou vivre?(mourir/vivre)", "Druide", 0)

Node_story_3_6 = story(
    "vous voulez mourir ou vivre?(mourir/vivre)", "Archer", 0)

Node_story_3_7 = story(
    "vous voulez mourir ou vivre?(mourir/vivre)", "Barde", 0)

Node_story_3_8 = story(
    "vous voulez mourir ou vivre?(mourir/vivre)", "Troll", 0)

Node_story_3_9 = story(
    "vous voulez mourir ou vivre?(mourir/vivre)", "Orc", 0)

Node_story_3_10 = story(
    "vous voulez mourir ou vivre?(mourir/vivre)","Nécromancien", 0)

Node_story_3_11 = story(
    "vous voulez mourir ou vivre?(mourir/vivre)", "Chasseur", 0)


Node_story_4_1_2 = story(
    "vous êtes mort ", "mourir", 1)

Node_story_4_2_2 = story(
    "vous êtes mort", "mourir", 1)

Node_story_4_3_2 = story(
    "vous êtes mort", "mourir", 1)

Node_story_4_4_2 = story(
    "vous êtes mort", "mourir", 1)

Node_story_4_5_2 = story(
    "vous êtes mort", "mourir", 1)

Node_story_4_6_2 = story(
    "vous êtes mort", "mourir", 1)

Node_story_4_7_2 = story(
    "vous êtes mort", "mourir", 1)

Node_story_4_8_2 = story(
    "vous êtes mort", "mourir", 1)

Node_story_4_9_2 = story(
    "vous êtes mort", "mourir", 1)

Node_story_4_10_2 = story(
    "vous êtes mort", "mourir", 1)

Node_story_4_11_2 = story(
    "vous êtes mort", "mourir", 1)
...
Node_story_5_6_2 = story(
    "La grand mere vous a tuer , vous êtes mort", "l'aide", 1)

Node_story_5_7_2 = story(
    "quel mauvais Barde vous êtes partie en prison", "tuer", 1)

Node_story_5_8_2 = story(
    "La grand mere vous a tuer , vous etes mort", "l'aide", 1)

Node_story_5_9_2 = story(
    "La grand mere vous a tuer , vous etes mort", "l'aide", 1)
